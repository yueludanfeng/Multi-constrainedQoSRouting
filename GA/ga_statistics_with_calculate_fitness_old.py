...
class Chromosome:
    ...
    def crossover_improv2(self, chromosome2, graph, pc):
        ...
        if existence != 0:
            ...
            #     fitness1 = Global.k / sum_cost_of_solution1_after
            # else:
            #     fitness1 = Global.k / (Global.r * sum_cost_of_solution1_after)
            #
            # if delta_sum_delay2 >= 0:
            #     fitness2 = Global.k / sum_cost_of_solution2_after
            # else:
            #     fitness2 = Global.k / (Global.r * sum_cost_of_solution2_after)
...
class Population:
    ...
    def crossover(self):
        ...
        for num in range(self.pop_size / 2):
            ...
            # 只考虑花费cost
            mate_pool_bak += self.mate_pool[num * 2].crossover_improv1(self.mate_pool[num * 2 + 1], self.graph, self.pc)
            # mate_pool_bak += self.mate_pool[num*2].crossover_improv1(self.mate_pool[num*2+1], self.graph, self.pc)
